            ...
            {carrito.length === 0 
                ...
                <div className="contenedor">
                    ...
                    <div>
                        ...
                        <Link to={"/"}>
                        <button type="button" className="btn button mt-4 py-1 botonPrincipal mx-3" onClick={() => "borrar producto"}>Continuar comprando</button>
                        </Link>
                        <Link to={"/checkout"}>
                        <button type="button" className="btn button mt-4 py-1 botonPrincipal mx-3" onClick={() => "borrar producto"}>Finalizar compra</button>
                        </Link>
                    </div>
                </div>
            }
